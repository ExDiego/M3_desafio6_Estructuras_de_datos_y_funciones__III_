...
from validador import validate_eleccion
import time
import os
import sys
...
eleccion_valida = validate_eleccion(opcion, opciones_validas)
...
while correcto and n_pregunta < 3*p_level:
    ...
    if n_pregunta == 0:
        ...
        while p_level not in ['1', '2', '3']:
            print("Número de preguntas por nivel invalido. Por favor vuelva a intentar.")
            p_level = int(p_level)
    ...
    if continuar == 'y':
        ...
        respuesta = validate_eleccion(respuesta)
